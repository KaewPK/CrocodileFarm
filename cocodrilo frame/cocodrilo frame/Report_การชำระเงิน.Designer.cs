...
{
    partial class Report_การชำระเงิน
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.tbl_การชำระเง_นBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ((System.ComponentModel.ISupportInitialize)(this.tbl_การชำระเง_นBindingSource)).BeginInit();
            this.SuspendLayout();
            // 
            // bt_ดูรายงาน
            // 
            ...
            reportDataSource1.Name = "การชำระเงิน";
            reportDataSource1.Value = this.tbl_การชำระเง_นBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "cocodrilo_frame.Report_การชำระเงิน.rdlc";
            ...
            // 
            // tbl_การชำระเง_นBindingSource
            // 
            this.tbl_การชำระเง_นBindingSource.DataSource = typeof(cocodrilo_frame.tbl_การชำระเง_น);
            // 
            // Report_การชำระเงิน
            // 
            ...
            this.Name = "Report_การชำระเงิน";
            this.Text = "Report_การชำระเงิน";
            this.Load += new System.EventHandler(this.Report_การชำระเงิน_Load);
            ((System.ComponentModel.ISupportInitialize)(this.tbl_การชำระเง_นBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource tbl_การชำระเง_นBindingSource;
    }
}